...
export const GET_FILTERED_PRODUCTS_FAILED = "GET_FILTERED_PRODUCTS_FAILED";
...
export const SEARCH_FOR_PRODUCT_START = "SEARCH_FOR_PRODUCT_START";
export const SEARCH_FOR_PRODUCT_SUCCESS = "SEARCH_FOR_PRODUCT_SUCCESS";

export const FILTER_BY_PRICE_START = "FILTER_BY_PRICE_START";
export const FILTER_BY_PRICE_SUCCESS = "FILTER_BY_PRICE_SUCCESS";
export const FILTER_BY_PRICE_FAILED = "FILTER_BY_PRICE_FAILED";

export const FILTER_BY_BRAND = "FILTER_BY_BRAND";

export const FILTER_BY_BRAND_START = "FILTER_BY_BRAND_START";
export const FILTER_BY_BRAND_SUCCESS = "FILTER_BY_BRAND_SUCCESS";
export const FILTER_BY_BRAND_FAILED = "FILTER_BY_BRAND_FAILED";
